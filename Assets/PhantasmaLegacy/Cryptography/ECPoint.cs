...
namespace Poltergeist.PhantasmaLegacy.Cryptography.ECC
{
    ...
    public class ECPoint : IComparable<ECPoint>, IEquatable<ECPoint>
    {
        ...
        internal static ECPoint Multiply(ECPoint p, BigInteger k)
        {
            ...
            // Determine optimal width and corresponding length of precomputation array based on literature values
            if (m < 13)
            {
                width = 2;
                reqPreCompLen = 1;
            ...
            {
                // Precomputation array must be made bigger, copy existing preComp array into the larger new preComp array
