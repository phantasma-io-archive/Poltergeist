                    ...
                    if (success)
                    {
                        ...
                        switch (kind)
                        {
                            ...
                            case SignatureKind.ECDSA:
                                ...
                                var signatureBytes = Poltergeist.Neo2.Utils.CryptoUtils.Sign(msg, ethKeys.PrivateKey, ethKeys.PublicKey, Poltergeist.Neo2.Cryptography.ECC.ECDsaCurve.Secp256k1);
